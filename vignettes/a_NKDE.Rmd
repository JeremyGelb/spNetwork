...
Of course, it uses the network distance instead of the euclidean distance. This method is appealing because it is intuitive, but not statistically satisfying. Note that the divisor of the kernel is not the classical *1/n*, but *1/bw*. This adjustment allows for a simpler interpretation of the density: *"Instead of calculating the density over an area unit, the equation estimates the density over a linear unit"* [@xie2008kernel p.398]
