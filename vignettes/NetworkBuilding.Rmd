...
We will also start by aggregating the points that are too close to each other. We will aggregate all the points that are within a 5 meters radius.
...
# second: nn mergning between original points and snapped points
