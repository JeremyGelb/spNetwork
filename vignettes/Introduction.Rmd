...
With a range *r* and *n* events for which the distance between each event *i* and *l* (*d<sub>il</sub>*) smaller than *r*. K is the kernel function.

This differs from the original estimation for planar data : 

$\lambda(l) = \sum_{i=1}^n \dfrac{1}{r^2}k(\dfrac{d_{il}}{r})$

The three most used kernel function actually implemented are : 
...
netlistw4 <- line_center_listw_gridded.mc(lixels,
                                   maxdistance = 450,
                                   dist_func = "squared inverse",
                                   line_weight = 'length',
                                   matrice_type = 'W',
