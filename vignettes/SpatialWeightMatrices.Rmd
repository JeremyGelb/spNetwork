...
netlistw <- network_listw(lixels,mtl_network,
                           ...
                           verbose=FALSE)
```
With that matrix, we can calculate the Moran I for the number of accident on lixels.
...
* With a little bit of work, it is possible to use the functions presented above to find the nearest feature of observations on a network as described [here](https://github.com/JeremyGelb/spNetwork/issues/3)
