...
#' An extract of Montreal road network with only the main roads
#'
#' A SpatialLinesDataFrame representing the main roads of the road network of
#' Montreal.
#'
#' @format A SpatialLinesDataFrame with 17304 rows and 3 variables: \describe{
#'   \item{CLASS}{The class of the road}
...
#' Libraries
#'
#' A SpatialPointsDataFrame representing some libraries in Montreal
#'
...
#' Theatres
#'
#' A SpatialPointsDataFrame representing some theatres in Montreal
#'
