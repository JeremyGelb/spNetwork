...
Currently, functions to calculate K-function and cross-K-function and k-nearest neighbours for sets of points are available but still experimental.

We also added functions for bandwidth selection by likelihood cross-validation
