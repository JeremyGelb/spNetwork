...
#include <b/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <b/call_traits.hpp> // for boost::call_traits
#include <b/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <b/assert.hpp>      // for BOOST_ASSERT
#include <b/integer/common_factor_rt.hpp> // for boost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <b/static_assert.hpp>  // for BOOST_STATIC_ASSERT
