...
#include <b/math/special_functions/beta.hpp> // for ibeta(a, b, x) == Ix(a, b).
#include <b/math/distributions/complement.hpp> // complement.
#include <b/math/distributions/detail/common_error_handling.hpp> // error checks domain_error & logic_error.
#include <b/math/special_functions/fpclassify.hpp> // isnan.
#include <b/math/tools/roots.hpp> // for root finding.
#include <b/math/distributions/detail/inv_discrete_quantile.hpp>
