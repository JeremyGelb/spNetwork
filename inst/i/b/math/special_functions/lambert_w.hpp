...
#include <b/math/special_functions/log1p.hpp> // for log (1 + x)
#include <b/math/constants/constants.hpp> // For exp_minus_one == 3.67879441171442321595523770161460867e-01.
#include <b/math/special_functions/next.hpp>  // for has_denorm_now
#include <b/math/special_functions/pow.hpp> // powers with compile time exponent, used in arbitrary precision code.
#include <b/math/tools/series.hpp> // series functor.
//#include <b/math/tools/polynomial.hpp>  // polynomial.
#include <b/math/tools/rational.hpp>  // evaluate_polynomial.
#include <b/math/tools/precision.hpp> // boost::math::tools::max_value().
...
#include <iostream>
#include <typeinfo>
#include <b/math/special_functions/next.hpp>  // For float_distance.
...
#include <b/math/special_functions/detail/lambert_w_lookup_table.ipp>
