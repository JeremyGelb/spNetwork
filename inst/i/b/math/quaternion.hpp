...
#include <b/math/special_functions/sinc.hpp>    // for the Sinus cardinal
#include <b/math/special_functions/sinhc.hpp>    // for the Hyperbolic Sinus cardinal
