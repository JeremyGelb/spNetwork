...
#include <b/iterator/iterator_adaptor.hpp> // for enable_if_convertible
#include <b/iterator/iterator_categories.hpp>

#include <b/iterator/minimum_category.hpp>

#include <utility> // for std::pair
#include <b/fusion/adapted/boost_tuple.hpp> // for backward compatibility
