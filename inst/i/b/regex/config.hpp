...
#if !defined(BOOST_REGEX_STANDALONE) && !__has_include(<b/version.hpp>)
...
#  include <b/regex/config/borland.hpp>
#endif
...
#     define BOOST_REGEX_USER_CONFIG <b/regex/user.hpp>
#  endif
...
#  include <b/predef.h>
   ...
   /*
    * C build,
    * don't include <b/config.hpp> because that may
...
#  include <b/regex/config/cwchar.hpp>
#endif
