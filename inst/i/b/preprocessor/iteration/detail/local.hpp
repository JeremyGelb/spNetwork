...
#        include <b/preprocessor/iteration/detail/start.hpp>
#        define BOOST_PP_VALUE BOOST_PP_TUPLE_ELEM(2, 1, BOOST_PP_LOCAL_LIMITS)
#        include <b/preprocessor/iteration/detail/finish.hpp>
...
#    include <b/preprocessor/iteration/detail/rlocal.hpp>
# else
#
...
#    include <b/preprocessor/iteration/detail/limits/local_256.hpp>
#    elif BOOST_PP_LIMIT_ITERATION == 512
#    include <b/preprocessor/iteration/detail/limits/local_256.hpp>
#    include <b/preprocessor/iteration/detail/limits/local_512.hpp>
#    elif BOOST_PP_LIMIT_ITERATION == 1024
#    include <b/preprocessor/iteration/detail/limits/local_256.hpp>
#    include <b/preprocessor/iteration/detail/limits/local_512.hpp>
#    include <b/preprocessor/iteration/detail/limits/local_1024.hpp>
#    else
