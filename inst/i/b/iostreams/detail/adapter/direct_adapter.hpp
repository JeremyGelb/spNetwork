...
#include <b/config.hpp>       // SFINAE, MSVC, put ptrdiff_t in std.
#include <algorithm>              // copy, min.
#include <cstddef>                // ptrdiff_t.
#include <b/detail/workaround.hpp>
#include <b/iostreams/categories.hpp>
#include <b/iostreams/detail/config/limits.hpp>        // forwarding.
#include <b/iostreams/detail/config/wide_streams.hpp>  // locale.
#include <b/iostreams/detail/double_object.hpp>
#include <b/iostreams/detail/error.hpp>
#include <b/iostreams/detail/ios.hpp>  // openmode, seekdir, int types.
...
// Must come last.
#include <b/iostreams/detail/config/disable_warnings.hpp> // VC7.1
