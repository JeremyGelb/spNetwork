...
#include <b/config.hpp>                 // Make sure ptrdiff_t is in std.
#include <algorithm>                        // copy, min.
#include <cstddef>                          // ptrdiff_t.
#include <utility>                          // pair.

#include <b/detail/workaround.hpp>
#include <b/iostreams/chain.hpp>
#include <b/iostreams/constants.hpp>
#include <b/iostreams/detail/adapter/non_blocking_adapter.hpp>        
...
#include <b/iostreams/detail/resolve.hpp>                   
#include <b/iostreams/detail/wrap_unwrap.hpp>
#include <b/iostreams/operations.hpp>  // read, write, close.
