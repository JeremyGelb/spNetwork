...
#include <b/detail/workaround.hpp>           // default_filter_buffer_size.
...
#include <b/iostreams/detail/counted_array.hpp>
#include <b/iostreams/detail/execute.hpp>
#include <b/iostreams/detail/functional.hpp> // clear_flags, call_reset
