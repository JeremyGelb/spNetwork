...
#include <b/iostreams/detail/config/codecvt.hpp> // mbstate_t.
#include <b/iostreams/detail/config/fpos.hpp>
#include <b/iostreams/detail/ios.hpp> // streamoff, streampos.
