...
#include <new>          
#include <b/config.hpp>  // MSVC, STATIC_CONSTANT, DEDUCED_TYPENAME, DINKUM.
#include <b/cstdint.hpp> // uint*_t
...
#include <b/iostreams/detail/config/zlib.hpp>
#include <b/iostreams/detail/ios.hpp>  // failure, streamsize.
#include <b/iostreams/filter/symmetric.hpp>                
