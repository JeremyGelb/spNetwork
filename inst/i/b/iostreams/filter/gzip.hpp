...
#include <b/config.hpp> // STATIC_CONSTANT, STDC_NAMESPACE, 
...
#include <b/config.hpp>               // Put size_t in std.
#include <b/detail/workaround.hpp>
#include <b/cstdint.hpp>              // uint8_t, uint32_t.
#include <b/iostreams/checked_operations.hpp>
#include <b/iostreams/constants.hpp>  // buffer size.
...
#include <b/iostreams/filter/zlib.hpp>
#include <b/iostreams/pipeline.hpp>     
#include <b/iostreams/putback.hpp>
