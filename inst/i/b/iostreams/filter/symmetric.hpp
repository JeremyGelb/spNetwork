...
#include <b/iostreams/detail/config/limits.hpp>
#include <b/iostreams/detail/ios.hpp>  // streamsize.
#include <b/iostreams/detail/template_params.hpp>
#include <b/iostreams/traits.hpp>
#include <b/iostreams/operations.hpp>       // read, write.
