...
//
// b/cstdint.hpp:428:35: error: use of C99 long long integer constant
//
...
// See https://svn.boost.org/trac/b/ticket/3548 and http://sources.redhat.com/bugzilla/show_bug.cgi?id=10990
//
...
# else
#    error defaults not correct; you must hand modify b/cstdint.hpp
# endif
...
// to define them all, see https://svn.boost.org/trac/b/ticket/12786
//
#undef INT8_C
#undef INT16_C
#undef INT32_C
