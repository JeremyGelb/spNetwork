...
#include <b/iterator/iterator_traits.hpp> // iterator_difference
...
#include <b/preprocessor/list/for_each.hpp>
...
#include <b/utility/enable_if.hpp> // disable_if
